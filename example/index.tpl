...
<html lang="zh-Hans">
    ...
    <body>
        ...
        <section class="op-panel">
            <a href="https://github.com/alienzhou/web-highlighter" target="_blank">Repository in Github >></a>
            <div>
                <label class="op-name">高亮code：</label>
                <label><input name="exception" type="radio" value="on" checked disabled />禁止</label>
                <label><input name="exception" type="radio" value="off" disabled />允许</label>
            </div>
            <div>
